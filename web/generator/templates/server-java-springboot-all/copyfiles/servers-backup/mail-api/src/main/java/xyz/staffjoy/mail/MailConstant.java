...
public class MailConstant {
    ...
    public static final String FROM_NAME = "service";
    public static final String FROM = "service@koudaibook.com";
    public static final String STAFFJOY_EMAIL_SUFFIX = "@qq.com";
