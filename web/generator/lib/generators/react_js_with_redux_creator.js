...
var config = {
    ...
    workControllerTemplatePath:function(){return path.join(this.templatePath() ,"reduxController",this.endName, "/");},
...
function copyFrameworkFiles(){
    ...
    var commonPath = config.workCopyFilesTemplatePath() + "/common/";
