...
//    XmoduleQueryDao queryDao;
    ...
    public List<Xmodule> queryByProject(@RequestParam("id") Long id) {
        //Project item = projectService.findById(id);
        List<Xmodule> result = service.findByProjectId(id);
